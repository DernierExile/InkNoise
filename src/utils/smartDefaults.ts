...
export const LOOK_PRESETS: CreativePresetConfig[] = [
  ...
  // ── Pop-culture / cinéma · iconic looks (palettes 46-65) ──
  { id: 'giallo', label: 'Giallo', algorithm: 'halftone', colorMode: 'indexed', selectedPalette: 46,
    adjustments: { contrast: 12, blur: 0, noise: 0 }, postProcessing: { bloom: 8 } },
  { id: 'suspiria', label: 'Suspiria', algorithm: 'atkinson', colorMode: 'indexed', selectedPalette: 47,
    adjustments: { contrast: 12, blur: 1, noise: 0 }, postProcessing: { bloom: 18, vignette: 10 } },
  { id: 'nosferatu', label: 'Nosferatu', algorithm: 'atkinson', colorMode: 'indexed', selectedPalette: 48,
    adjustments: { contrast: 18, blur: 0, noise: 8 }, postProcessing: { vignette: 22 } },
  { id: 'carpenter', label: 'Carpenter', algorithm: 'ordered-8x8', colorMode: 'indexed', selectedPalette: 49,
    adjustments: { contrast: 8, blur: 0, noise: 0 }, postProcessing: { bloom: 16, scanlines: 18 } },
  { id: 'slasher', label: 'Slasher', algorithm: 'floyd-steinberg', colorMode: 'indexed', selectedPalette: 50,
    adjustments: { contrast: 22, blur: 0, noise: 0 }, postProcessing: { vignette: 14 } },
  { id: 'sin-city', label: 'Sin City', algorithm: 'atkinson', colorMode: 'indexed', selectedPalette: 51,
    adjustments: { contrast: 20, blur: 0, noise: 0 }, postProcessing: { vignette: 12 } },
  { id: 'akira', label: 'Akira', algorithm: 'atkinson', colorMode: 'indexed', selectedPalette: 52,
    adjustments: { contrast: 10, blur: 0, noise: 0 }, postProcessing: { bloom: 6 } },
  { id: 'dune', label: 'Dune', algorithm: 'dot-pattern', colorMode: 'indexed', selectedPalette: 53,
    adjustments: { contrast: 6, blur: 0, noise: 4 }, postProcessing: { vignette: 8 } },
  { id: 'maverick', label: 'Maverick', algorithm: 'ordered-8x8', colorMode: 'indexed', selectedPalette: 54,
    adjustments: { contrast: 4, blur: 0, noise: 0 }, postProcessing: { bloom: 10 } },
  { id: 'miami', label: 'Miami', algorithm: 'atkinson', colorMode: 'indexed', selectedPalette: 55,
    adjustments: { contrast: 6, blur: 0, noise: 0 }, postProcessing: { bloom: 20, chromaticAberration: 8 } },
  { id: 'tron', label: 'Tron', algorithm: 'ordered-8x8', colorMode: 'indexed', selectedPalette: 56,
    adjustments: { contrast: 6, blur: 0, noise: 0 }, postProcessing: { bloom: 26, scanlines: 10 } },
  { id: 'matrix', label: 'Matrix', algorithm: 'bayer-16x16', colorMode: 'indexed', selectedPalette: 57,
    adjustments: { contrast: 8, blur: 0, noise: 0 }, postProcessing: { scanlines: 26, bloom: 14, crtCurve: 16 } },
  { id: 'western', label: 'Spaghetti Western', algorithm: 'halftone', colorMode: 'indexed', selectedPalette: 58,
    adjustments: { contrast: 8, blur: 0, noise: 6 }, postProcessing: { vignette: 14 } },
  { id: 'film-noir', label: 'Film Noir', algorithm: 'atkinson', colorMode: 'indexed', selectedPalette: 59,
    adjustments: { contrast: 24, blur: 0, noise: 0 }, postProcessing: { vignette: 18 } },
  { id: 'wes-anderson', label: 'Wes Anderson', algorithm: 'ordered-4x4', colorMode: 'indexed', selectedPalette: 60,
    adjustments: { contrast: -4, brightness: 3, blur: 0, noise: 0 }, postProcessing: {} },
  { id: 'technicolor', label: 'Technicolor', algorithm: 'stucki', colorMode: 'indexed', selectedPalette: 61,
    adjustments: { contrast: 8, saturation: 120, blur: 0, noise: 0 }, postProcessing: { bloom: 6 } },
  { id: 'pulp', label: 'Pulp', algorithm: 'dot-pattern', colorMode: 'indexed', selectedPalette: 62,
    adjustments: { contrast: 8, blur: 0, noise: 4 }, postProcessing: {} },
  { id: 'grindhouse', label: 'Grindhouse', algorithm: 'blue-noise', colorMode: 'indexed', selectedPalette: 63,
    adjustments: { contrast: 10, blur: 0, noise: 14 }, postProcessing: { vignette: 20, scanlines: 12 } },
  { id: 'polaroid', label: 'Polaroid', algorithm: 'ordered-4x4', colorMode: 'indexed', selectedPalette: 64,
    adjustments: { contrast: -6, brightness: 4, blur: 0, noise: 0 }, postProcessing: { vignette: 10 } },
  { id: 'kill-bill', label: 'Kill Bill', algorithm: 'halftone', colorMode: 'indexed', selectedPalette: 65,
    adjustments: { contrast: 14, blur: 0, noise: 0 }, postProcessing: {} },
];
