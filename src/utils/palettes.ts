...
export const PREDEFINED_PALETTES: ColorPalette[] = [
  ...
  // ── Pop-culture / cinéma · iconic looks (46+) ──
  { name: 'Giallo', colors: ['#0a0a0a', '#7a0d12', '#d11a1a', '#e8b84a', '#f2e9d0'] },
  { name: 'Suspiria', colors: ['#08040f', '#7a0f2a', '#e10b2a', '#00b4ff', '#f3e3d8'] },
  { name: 'Nosferatu', colors: ['#0c0c0e', '#2e2e34', '#5a5a62', '#9a9aa0', '#e8e6df'] },
  { name: 'Carpenter', colors: ['#04060a', '#0a2230', '#0f5a73', '#1fb6ff', '#cfeeff'] },
  { name: 'Slasher', colors: ['#0a0a0a', '#b11212', '#e23a3a', '#f4f4f1'] },
  { name: 'Sin City', colors: ['#050505', '#2a2a2a', '#e10600', '#bdbdbd', '#f4f4f1'] },
  { name: 'Akira', colors: ['#0a0a0c', '#8a0a06', '#e10600', '#f2efe6'] },
  { name: 'Dune', colors: ['#1a0f06', '#5a2f12', '#9a5a22', '#d9863b', '#f0c27b', '#f5e6c8'] },
  { name: 'Maverick', colors: ['#0b1a2a', '#173a52', '#1f7f9c', '#e8884a', '#f4c35a', '#f5efe6'] },
  { name: 'Miami', colors: ['#0a0a16', '#3a1f5a', '#ff4d9e', '#00d5d5', '#ffd35a', '#f5e9f0'] },
  { name: 'Tron', colors: ['#02060a', '#0a3a4a', '#0a6a82', '#00e5ff', '#eaffff'] },
  { name: 'Matrix', colors: ['#000a04', '#003a16', '#00702a', '#00ff66', '#b6ffcf'] },
  { name: 'Spaghetti Western', colors: ['#241405', '#5a3a1a', '#8a5a2a', '#b8854a', '#e6c98f', '#f3e6c8'] },
  { name: 'Film Noir', colors: ['#070707', '#262626', '#5a5a5a', '#9a9a9a', '#f4f4f1'] },
  { name: 'Wes Anderson', colors: ['#2a2a2e', '#b56576', '#e8a07a', '#f6d7c4', '#88b8b0', '#d9c44a'] },
  { name: 'Technicolor', colors: ['#0a0a0a', '#d11a2a', '#1f8a3b', '#1f5fd1', '#f4d35e', '#f4f4f1'] },
  { name: 'Pulp', colors: ['#e8dcc0', '#c1272d', '#3a2a1a', '#1a1a1a'] },
  { name: 'Grindhouse', colors: ['#1a120a', '#4a3420', '#7a5a3a', '#b89a72', '#d8c0a0'] },
  { name: 'Polaroid', colors: ['#2a2622', '#6a5a4a', '#9a8a72', '#b8a890', '#e8d8c0', '#f2ece0'] },
  { name: 'Kill Bill', colors: ['#0a0a0a', '#f5c518', '#d11a1a', '#f4f4f1'] }
];
