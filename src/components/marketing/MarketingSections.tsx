...
const PRODUCTION_PACK_FILES = [
  ...
  { key: 'image1', href: '/samples/production-pack/campaign-01-editorial.jpg' },
  { key: 'image2', href: '/samples/production-pack/campaign-02-food.jpg' },
] as const;
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.15fr_1.35fr] gap-4">
          <div className="panel-surface overflow-hidden">
            <div className="grid grid-cols-2 gap-px bg-bz-grid">
              <img src="/samples/production-pack/campaign-01-editorial.jpg" alt="" className="aspect-[4/3] w-full object-cover bg-bz-deep" loading="lazy" />
              <img src="/samples/production-pack/campaign-02-food.jpg" alt="" className="aspect-[4/3] w-full object-cover bg-bz-deep" loading="lazy" />
            </div>
            <div className="p-5">
