          ...
          <div className="relative">
            ...
            {open && (
              <div className="absolute z-20 left-0 right-0 mt-1 max-h-64 overflow-y-auto bg-bz-deep border border-bz-grid">
                <button
                  onClick={() => { onActivePresetIdChange(null); setOpen(false); }}
                  className={`w-full text-left px-2 py-1.5 text-[10px] font-mono-ui tracking-wide border-b border-bz-grid transition-colors duration-240 ${
                    activePresetId === null ? 'text-bz-cyan bg-bz-graphite/40' : 'text-bz-system hover:bg-bz-graphite/60'
                  }`}
                >
                  {t('presets.none')}
                </button>
