    ...
    extend: {
      colors: {
        bz: {
          ...
          // Signal — sparingly
          // Note: token name kept as `cyan` for backward compat across components.
          // Value is now Riso orange (Claude Design redesign 2026-05-09).
          cyan:      '#E84A1F',  // primary signal · Riso orange (formerly cyan #00D5FF)
          violet:    '#5361FF',  // secondary signal (optional, unused)
          accent:    '#E84A1F',  // alias for clarity in new code (use this going forward)
        },
      },
      fontFamily: {
        display: ['Geist', 'Inter', 'Söhne', 'Suisse Intl', 'Neue Haas Grotesk', 'system-ui', 'sans-serif'],
        sans:    ['Geist', 'Inter', 'Söhne', 'Suisse Intl', 'system-ui', 'sans-serif'],
